...
COPY . .
WORKDIR "/src/MerchantService"
RUN dotnet build "MerchantService.csproj" -c Release -o /app/build

FROM build AS publish
RUN dotnet publish "MerchantService.csproj" -c Release -o /app/publish
